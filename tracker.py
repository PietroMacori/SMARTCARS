...
color = ["cyan", "yellow", "palegreen", "green", "pink", "grey", "red", "orange", "gold", "purple", "lime", "peru",
         "yellow", "pink", "teal", "darksalmon", "skyblue", "plum", "coral", "yellowgreen", "tan","royalblue"]
...
class CentroidTracker:
    ...
    def register(self, centroid):
        ...
        self.colors[self.nextObjectID] = color[self.nextObjectID % 22]
